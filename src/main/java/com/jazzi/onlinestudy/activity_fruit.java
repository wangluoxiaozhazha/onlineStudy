...
public class activity_fruit extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(activity_fruit.this,"已添加至我喜欢",Toast.LENGTH_LONG).show();
            }
        });
        //添加按钮
        ...
        String courseImageUrl=IpConfig.getIp()+":8080/getImage/?id="+id;
    ...
    * 如果不是，就加载它父类的方法，对相应的点击操作相应*/
    ...
    public void onClick(View v){
        ...
        Intent intent=new Intent(activity_fruit.this,VideoActivity.class);
            ...
            public void run() {
                ...
                try {
                    ...
                    Request request=new Request.Builder()
                            .url(IpConfig.getIp()+":8080/user/updatelike")
                            .post(requestBody)
                            .build();
